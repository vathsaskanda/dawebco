...
export function AiChatbotSection() {
  ...
  return (
    <section className={`relative py-16 md:py-32 transition-colors duration-300 ${isDark ? "bg-[#000000] border-y border-dashed border-[#1c1c1c]" : "bg-[#F8C8DC] border-y border-border"}`}>
          ...
          {PILLARS.map((pillar, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative group p-5 md:p-8 transition-all duration-500 ${isDark ? "bg-[#1c1c1c] border border-dashed border-[#000000] rounded-[20px]" : "rounded-2xl border border-border bg-card backdrop-blur-sm hover:shadow-lg"}`}
              >
